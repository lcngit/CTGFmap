...
%_version/date: v1.0.1r0/2017.09.05
%_application: CTGF Features mapping

function DocMetrics = CTGFmap_Experiment_FrmToDoc_DsTime( ...
    n_cls, exp_num, exp_type, mtd, rnk_type, dsz, FV_lengths, seq)
...
for cls = 1:n_cls
    frmsuffix = strcat('_C', num2str(cls), ...
        '_R', num2str(rnk_type),...
...
[DocAttribClasses, DocMetrics] = CTGFmap_FrmToDoc(FrmAttribClasses, ...
    n_cls, exp_num, exp_type, mtd, FV_lengths);
